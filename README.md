...
(`crates/hub-drivers/assets/touroku_kanryo_16k_s16le.raw`、16kHz mono s16le)。
...
`outputSamplingRate=16000` / `outputStereo=false` を指定し、無音トリム +
ピーク正規化 (20000) して差し替える (issue #101/#102)。
